...
Escreva uma função chamada +mulhora+ que pega um objeto +MeuHorário+ e um número, e retorna um novo objeto +MeuHorário+ que contém o produto do +MeuHorário+ original e do número.
(((mulhora)))((("função", "definido pelo programador", "mulhora", see="mulhora")))
