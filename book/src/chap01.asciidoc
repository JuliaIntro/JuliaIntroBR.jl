...
À princípio, você estará aprendendo a programar, uma habilidade muito útil à você. Após, você usará a programação como um significado para o fim. Na medida que formos evoluindo, esse fim ficará mais claro.
