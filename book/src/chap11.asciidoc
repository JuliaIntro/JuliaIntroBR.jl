...
[WARNING]
====
Uma consulta invertida é muito mais demorada que uma consulta normal; se você tiver que executá-la várias vezes, ou se o dicionário ficar muito grande, o desempenho do seu programa diminuirá.
====
...
Leia a documentação da função de dicionário +get!+ e use-a para escrever uma versão mais concisa de +invertdict+.
(((get!)))((("função", "Base", "get!", see="get!")))
