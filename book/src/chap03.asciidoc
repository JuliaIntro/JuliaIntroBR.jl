...
(((conversão de tipo)))(((("função","Base","converter", veja ="parse")))(((erro no argumento)))(((("erro","centro","erro no argumento", see="ArgumentError")))
...
(((truncar)))((("função", "Base", "truncar", see="trunc")))
...
(((raiz quadrada)))((("função", "Base", "raiz quadrada", see="sqrt")))((("função quadrática", see="sqrt")))
...
----
function imprimirletrademúsica()
...
((("palavra chave", "função", see="function")))(((argumento)))(((caracteres Unicode)))
...
(((cabeçalho)))(((corpo)))(((end)))((("palavra chave", "end", see="end")))(((indentação)))
...
As aspas devem ser "aspas retas", geralmente localizadas ao lado do Enter no teclado. As "aspas encaracoladas", como as que estão nesta frase, não são legais em Júlia.
