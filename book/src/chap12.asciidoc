...
Este capítulo apresenta mais um tipo interno, a tupla, e mostra como vetores, dicionários e tuplas funcionam juntos. Também apresento um recurso útil para vetores de argumentos de tamanho variável, operadores de coleta e de dispersão.
...
Uma tupla é uma sequência de valores. Os valores podem ser de qualquer tipo e são indexados por números inteiros; logo, neste aspecto, as tuplas são muito similares a vetores. A diferença importante é que as tuplas são imutáveis e que cada elemento pode ter seu próprio tipo.
(((tupla)))(((imutável)))
