...
Este capítulo apresenta mais um tipo interno, a tupla, e mostra como matrizes, dicionários e tuplas funcionam juntos. Também apresento um recurso útil para matrizes de argumentos de comprimento variável, operadores de coleta e dispersão.

Este capítulo apresenta mais um tipo embutido, o tuple, e então mostra como matrizes, dicionários e tupilos trabalham juntos. Eu também apresento um recurso útil para arrays de argumentos de comprimento variável, os operadores de agrupamento e dispersão.
...
[NOTA]
====
Não há consenso sobre como pronunciar "tupla". Algumas pessoas dizem "tuh-ple", que rima com "flexível". Mas, no contexto da programação, a maioria das pessoas diz "muito ple", que rima com "quádruplo".

[NOTA].

Não há consenso sobre como pronunciar "tuple". Algumas pessoas dizem "tuh-ple", que rima com "suave". Mas no contexto da programação, a maioria das pessoas diz "too-ple", que rima com "quadruplicar".
