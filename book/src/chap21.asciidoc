...
Um dos problemas com o uso de instruções de impressão para depuração é que você pode acabar enterrado na saída. Existem duas maneiras de proceder: simplificar a saída ou simplificar o programa.

Um dos problemas com o uso de comandos de impressão para depuração é que você pode acabar enterrado na saída. Há duas maneiras de proceder: simplificar a saída ou simplificar o programa.
...
Para simplificar a saída, você pode remover ou comentar os comandos de impressão que não estão ajudando, ou combiná-los, ou formatar a saída para que seja mais fácil de entender.

Para simplificar a saída, você pode remover ou comentar as instruções de impressão que não estão ajudando, combiná-las ou formatar a saída para facilitar a compreensão.
