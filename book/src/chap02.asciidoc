...
Comentários são bastante utéis quando eles documentam características não óbvias do código. É razoável assumir que o leitor consegue descobrir _o que_ o código faz; é mais útil explicar o _por quê_.
