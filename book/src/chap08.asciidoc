...
Para rotacionar uma palavra, rotacione cada letra pelo mesmo valor. Por exemplo +"ovo"+ rotacionado por 16 é +"ele"+ e +"melon"+ rotacionado por -10 é +"cubed"+. No filme _2001: Odisseia no espaço, o computador de bordo_ é chamado de HAL, que é IBM rotacionado por -1.
