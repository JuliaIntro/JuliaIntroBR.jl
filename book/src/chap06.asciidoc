...
(((distance)))((("função", "definido pelo programador", "distance", see="distance")))

O primeiro passo é considerar como deve ser uma função de distância em Julia. Em outras palavras, quais são as entradas (parâmetros) e qual é a saída (valor de retorno)?

O primeiro passo é considerar como deve ser uma função à distância em Júlia. Em outras palavras, o que são os inputs (parâmetros) e o que é o output (valor de retorno)?
...
Neste caso, os inputs são dois pontos, que você pode representar utilizando quatro números. O valor de retorno é a distância representada por um valor de vírgula flutuante.

**Nesse caso, as entradas são dois pontos que você pode representar usando quatro números. O valor de retorno é a distância representada por um valor de ponto flutuante.

Imediatamente você pode escrever um esboço da função:
(((distance))) (((("função", "definido pelo programador", "distance", veja = "distance"))))

Imediatamente você pode escrever um esboço da função:
(((distância)))((("função", "definido pelo programador", "distância", veja="distância"))))
...
(((circlearea)))((("função", "definido pelo programador", "circlearea", see="circlearea")))
...
(((boolean function)))(((isdivisible)))((("função", "definido pelo programador", "isdivisible", see="isdivisible")))
