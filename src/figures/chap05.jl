function fig05_1(output::Symbol, font::String, scale::Float64)
  ...
  \node[anchor=east] at(-1.5,-0.75){\tt contagem\_regressiva};
  ...
  \draw[-latex] (n1) -- (n1v);
  \node[anchor=east] at(-1.5,-1.5){\tt contagem\_regressiva};
  ...
  \draw[-latex] (n2) -- (n2v);
  \node[anchor=east] at(-1.5,-2.25){\tt contagem\_regressiva};
  ...
  \draw[-latex] (n3) -- (n3v);
  \node[anchor=east] at(-1.5,-3){\tt contagem\_regressiva};
