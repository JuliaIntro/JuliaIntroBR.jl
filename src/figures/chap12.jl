...
function fig12_2(output::Symbol, font::String, scale::Float64)
  ...
  \draw[-latex](ng)--(g);
  \node[anchor=east](ni) at(-0.25,0.25) {\tt ("Souza","Pedro")};
  \node[anchor=west](i) at(0.75,0.25) {\tt "08700 100 222"};
  \draw[-latex](ni)--(i);
  \node[anchor=east](nt) at(-0.25,-0.25) {\tt ("Machado","Paulo")};
  \node[anchor=west](t) at(0.75,-0.25) {\tt "08700 100 222"};
  \draw[-latex](nt)--(t);
  \node[anchor=east](nj) at(-0.25,-0.75) {\tt ("Coelho","Gabriel")};
  \node[anchor=west](j) at(0.75,-0.75) {\tt "08700 100 222"};
  \draw[-latex](nj)--(j);
  \node[anchor=east](np) at(-0.25,-1.25) {\tt ("Ribeiro","Manuel")};
